...
claude_code: { subagent_type: spec-driven-dev }
---
...
3. Output the current rung, the gaps holding them back, and the 3-5 highest-leverage actions to reach the next rung. Use `templates/spec-driven-maturity-assessment.md`.
