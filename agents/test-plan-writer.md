...
id_prefix: TEST
rtm_column: "Test case (TEST)"
upstream: [frd-writer, srs-writer]
downstream: [test-author, qa-tester, test-automation-engineer]
skills: [test-design]
claude_code: { command: /test-plan, subagent_type: test-plan-writer }
---
