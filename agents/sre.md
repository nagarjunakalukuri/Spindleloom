...
loop: outer-ship
agentic_role: maker
inputs: [SRS, SDD, ci-cd-pipeline, performance audit]
outputs: reliability-plan
id_prefix: OPS
rtm_column: "—"
upstream: [srs-writer, sdd-writer, pipeline-engineer, performance-engineer]
downstream: [incident-responder, release-manager]
