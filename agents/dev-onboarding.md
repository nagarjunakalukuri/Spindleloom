...
agentic_role: maker
inputs: []
outputs: onboarding/CONTRIBUTING guide + inner-loop readiness gate
rtm_column: "—"
upstream: []
downstream: [backend-developer, frontend-developer, flaky-test-detective]
skills: [conventional-commits-pr]
claude_code: { subagent_type: dev-onboarding }
---
