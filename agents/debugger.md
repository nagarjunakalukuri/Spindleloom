...
rtm_column: "—"
upstream: [change-verifier, backend-developer, frontend-developer, test-author, bug-triager, qa-tester]
downstream: [test-author]
skills: [verification-run-and-observe, systematic-debugging, agent-handoff-context]
claude_code: { subagent_type: debugger }
---
