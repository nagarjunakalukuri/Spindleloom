...
id_prefix: API
rtm_column: "Design (API contract)"
upstream: [frd-writer, sdd-writer]
downstream: [backend-developer, frontend-developer, test-automation-engineer]
skills: [api-contract, threat-modeling-stride]
claude_code: { subagent_type: api-designer }
---
