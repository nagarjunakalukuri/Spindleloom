...
## Hand-off
The analysis feeds `adr-writer` (records the decision + rationale, immutably) and, when it needs socializing first, `rfc-facilitator` (opens it for comment). You analyze and recommend; the ADR is the record.
